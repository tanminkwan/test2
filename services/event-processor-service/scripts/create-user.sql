-- Event Processor Service - PostgreSQL 데이터베이스 및 사용자 생성 스크립트
...
\echo '========================================='
\echo 'Event Processor Service 데이터베이스 설정 완료!'
\echo '사용자: app_user'
\echo '비밀번호: app123!@#'
\echo '데이터베이스: game_statistics'
\echo '테스트: psql -U app_user -h localhost -d game_statistics'
\echo '=========================================' 